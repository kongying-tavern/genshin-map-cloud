...
public class ClientSecurityDto implements ClientDetails {
    ...
    public ClientSecurityDto(OauthClientDetails oauthClientDetails) {
        CachedBeanCopier.copyProperties(oauthClientDetails, this);
    }
    ...
    public Collection<GrantedAuthority> getAuthorities() {
        return Optional.ofNullable(JSON.parseArray(authorities,String.class)).orElse(new ArrayList<>()).stream().map(RoleSecurityDto::new).collect(Collectors.toList());
    }
