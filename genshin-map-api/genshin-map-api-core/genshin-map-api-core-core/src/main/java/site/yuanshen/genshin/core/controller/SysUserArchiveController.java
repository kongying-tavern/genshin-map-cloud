...
public class SysUserArchiveController {
    ...
    public R<SysArchiveVo> getLastArchive(
        @PathVariable("slot_index") int slotIndex, @Parameter(hidden = true) @RequestHeader("userId") Long userId
    ) {
    ...
    public R<SysArchiveSlotVo> getHistoryArchive(
        @PathVariable("slot_index") int slotIndex, @Parameter(hidden = true) @RequestHeader("userId") Long userId
    ) {
    ...
    public R<List<SysArchiveSlotVo>> getAllHistoryArchive(
    ...
    public R<Boolean> createSlotAndSaveArchive(
        @PathVariable("slot_index") int slotIndex, @RequestBody String archive,
        @Parameter(hidden = true) @RequestHeader("userId") Long userId, @PathVariable("name") String name
    ) {
    ...
    public R<Boolean> renameSlot(
        @PathVariable("slot_index") int slotIndex, @PathVariable("new_name") String newName,
        @Parameter(hidden = true) @RequestHeader("userId") Long userId
    ) {
    ...
    public R<Boolean> removeArchive(
        @PathVariable("slot_index") int slotIndex, @Parameter(hidden = true) @RequestHeader("userId") Long userId
    ) {
